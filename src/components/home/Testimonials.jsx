...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-10 bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative px-12">
          ...
          {/* Card */}
          <div className="bg-white border border-slate-200/80 p-8 sm:p-12 rounded-3xl shadow-xl relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <blockquote className="text-xl sm:text-2xl font-semibold leading-relaxed mb-8 italic text-slate-700">
                "{current.quote}"
              </blockquote>
          ...
          <button 
            onClick={handlePrev} 
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-white hover:bg-slate-50 hover:scale-105 border border-slate-200 shadow-md w-12 h-12 rounded-full flex items-center justify-center transition-all cursor-pointer text-slate-600"
          ...
          <button 
            onClick={handleNext} 
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-white hover:bg-slate-50 hover:scale-105 border border-slate-200 shadow-md w-12 h-12 rounded-full flex items-center justify-center transition-all cursor-pointer text-slate-600"
